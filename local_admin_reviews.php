...
<html>
    ...
    <body>
        ...
        <?php 
        include('config.php');
        $sql4 = "SELECT review_id, given_at, review, dept_name, complaint, complaints.complaint_id, user_id, complaints.authority_id as 'authority_id' from complaints join reviews on complaints.complaint_id = reviews.complaint_id join departments on departments.dept_id = complaints.dept_id join authority_details ad on ad.authority_id = complaints.authority_id where local_admin_id = '$user_id'";
