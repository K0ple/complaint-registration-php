 ...
 ?>
    ...
    <body>
        <div class="sidebar">
            ...
            <a href="local_admin_main.php" ><i class="fa fa-home fa-fw"></i>DASHBOARD</a><br>
            <a href="edit_nonuser.php" >EDIT PROFILE</a><br>
            <a href="local_admin_complaints.php" >VIEW COMPLAINT</a><br>
            <a href="local_admin_reviews.php" >VIEW REVIEWS</a><br>
            <a href="local_admin_view_userdetails.php" >USER DETAILS</a><br>
            <a href="local_admin_view_auth_details.php" >AUTHORITIES</a><br>
